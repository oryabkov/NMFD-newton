...
int main(int argc, char const *args[])
{
    ...
    std::shared_ptr<static_vector_space_t> vec_space = std::make_shared<static_vector_space_t>();
    vector_type x = {1, 2, 3};
    vector_type y = {4, 5, 6};
    ...
    {
        auto vec_space2 = std::make_shared<static_vector_space_t>();
    ...
    {
        auto vec_space3 = std::make_shared<static_vector_space_t>();
