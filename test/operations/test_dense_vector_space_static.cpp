...
int main( int argc, char const *args[] )
{
    ...
    // Test vector space dimensions
    {
        ...
        {
            log.error(
                "✗ `size()` method test failed. Expected " + std::to_string( Dim ) + " but returned " +
                std::to_string( dim )
            );
            failed_counter++;
        }
    ...
    // Test scalar product (dot product)
    {
        ...
        {
            log.error(
                "✗ `scalar_prod(x, y)` method test failed. Expected 32 but "
                "returned " +
    ...
    // Test L2 norm
    {
        ...
        {
            log.error(
                "✗ `norm(x)` method test failed. Expected " + std::to_string( std::sqrt( 14 ) ) + " but returned " +
                std::to_string( norm )
            );
            failed_counter++;
        }
    ...
    log.info( "=== Testing Norm/Inner-Product Aliases ===" );
    {
        ...
        {
            log.error(
                "✗ `scalar_prod_l2` mismatch: sp=" + std::to_string( sp ) + ", sp_l2=" + std::to_string( sp_l2 )
            );
            failed_counter++;
        }
    ...
    // Test getting value at specific index
    {
        ...
        {
            log.error(
                "✗ `get_value_at_point(at, x)` method test failed. Expected 1 "
                "but returned " +
                std::to_string( value )
            );
            failed_counter++;
