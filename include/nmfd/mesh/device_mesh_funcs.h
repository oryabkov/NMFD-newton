...
struct device_mesh_funcs
{
        ...
        __DEVICE_TAG__ void operator()( const int &i ) const
        {
            ...
            for ( int k_spacial_dimension = 0; k_spacial_dimension < dim; k_spacial_dimension++ )
            {
                mesh().elems_centers( i, k_spacial_dimension ) =
                    sum_of_verteces_coords[k_spacial_dimension] / ( (scalar)max_vertex_in_the_element );
            }
        }
    };
    ...
    check_orientation_of_a_normal_vector( const t_vec &normal_vector, const t_vec &vertex_center_vector )
    {
    ...
    static __DEVICE_TAG__ t_vec construct_normal_vector_for_triangle_face(
        const t_vec &vertex_1, const t_vec &vertex_2, const t_vec &vertex_3, const t_vec &center
    )
    {
        ...
        __DEVICE_TAG__ void operator()( const int &i ) const
        {
            ...
            for ( int face_j = 0; face_j < elem_ref().get_faces_n( elem_type ); face_j++ )
            {
                ...
                if ( face_verteces_number == 3 )
                {
                    ...
                    t_vec normal_vector =
                        construct_normal_vector_for_triangle_face( verteces[0], verteces[1], verteces[2], center );
                ...
                else if ( face_verteces_number == 4 )
                {
                    ...
                    for ( int triangle_number = 0; triangle_number < face_verteces_number; triangle_number++ )
                    {
                        ...
                        normal_vector = construct_normal_vector_for_triangle_face(
                            verteces[vertex_index_1], verteces[vertex_index_2], face_center, center
                        );
    ...
    static __DEVICE_TAG__ scalar get_tetrahedron_volume( scalar tet_verteces[4][dim] )
    {
        ...
        scalar tet_volume;
        tet_volume = sc_tr::abs(
                         +tet_verteces[0][0] *
                             ( tet_verteces[1][1] * tet_verteces[2][2] - tet_verteces[2][1] * tet_verteces[1][2] ) -
                         tet_verteces[0][1] *
                             ( tet_verteces[1][0] * tet_verteces[2][2] - tet_verteces[2][0] * tet_verteces[1][2] ) +
                         tet_verteces[0][2] *
                             ( tet_verteces[1][0] * tet_verteces[2][1] - tet_verteces[2][0] * tet_verteces[1][1] )
                     ) /
                     scalar( 6.f );
        ...
        */
            ...
            if ( elem_type == 5 )
            {
                ...
                for ( int face_j = 0; face_j < number_of_faces; face_j++ )
                {
                    ...
                    hexahedron_volume +=
                        volume_of_4_tetraheda_from_4_verteces_and_center( verteces, face_center, element_center );
                }
            ...
            if ( elem_type == 7 )
            {
                ...
                mesh().elems_vols( i, 0 ) =
                    volume_of_4_tetraheda_from_4_verteces_and_center( verteces, face_center, vertex_pinacle_coords );
            }
        }
    };
