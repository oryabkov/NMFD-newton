...
#ifndef __NMFD_DETAIL_DENSE_OPERATIONS_H__
#define __NMFD_DETAIL_DENSE_OPERATIONS_H__
...
private:
    ...
    void check_init() const
    {
        if((rows_ == 0)&&(cols_ == 0))
        {
            ...
            throw std::logic_error("nmfd:lin_solvers:detail:dense_operations:: methods called withought class delayed initialization.");
        }
    }
